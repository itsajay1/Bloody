...
function RequestBlood() {
  ...
  const handleSubmit = async (e) => {
    ...
    setStatus({ type: 'loading', message: 'Intercepting nearby heroes...' });
    setDonors([]);
        ...
        <div className="relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-10" noValidate>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              />
              <div className="md:pt-1 font-bold">
                <LocationPicker
                  onLocation={(coords) => {
                    setLocation(coords);
            ...
            >
              ...
              <span>{status?.type === 'loading' ? 'Encrypting Signal...' : 'Trigger Frequency'}</span>
            </button>
          </form>
        </div>
      </div>
