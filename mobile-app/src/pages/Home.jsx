  ...
  return (
    <div className="max-w-7xl mx-auto py-10 px-6 sm:px-6 lg:px-8">
      ...
      <div className="text-center mb-16 animate-fade-in-up">
        <div className="inline-block px-4 py-1.5 rounded-full bg-red-50 border border-red-100 mb-6 font-black uppercase text-red-600 text-[10px] tracking-[0.2em]">
          Community Driven
        </div>
        <h2 className="text-5xl font-black text-gray-900 tracking-tighter sm:text-8xl mb-6 leading-none animate-float">
          Every Drop <br/>
          <span className="text-gradient">Saves Lives</span>
        </h2>
        <p className="mt-6 max-w-2xl text-lg sm:text-xl text-gray-500 mx-auto font-medium leading-relaxed">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 mt-10">
        ...
        {/* Donor Card */}
        <div className="glass rounded-[3rem] shadow-premium p-10 transform transition-all duration-700 flex flex-col items-center text-center group cursor-pointer border-white/60">
          <div className="w-24 h-24 bg-gradient-to-br from-red-500 to-red-700 text-white rounded-[2rem] flex items-center justify-center mb-8 shadow-2xl transform transition-transform group-active:scale-95 group-hover:scale-105 group-hover:rotate-3">
            <BloodDropIcon className="w-12 h-12" />
          </div>
        ...
        {/* Request Card */}
        <div className="glass rounded-[3rem] shadow-premium p-10 transform transition-all duration-700 flex flex-col items-center text-center group cursor-pointer border-white/60">
          <div className="w-24 h-24 bg-gradient-to-br from-gray-800 to-gray-950 text-white rounded-[2rem] flex items-center justify-center mb-8 shadow-2xl transform transition-transform group-active:scale-95 group-hover:scale-105 group-hover:-rotate-3">
