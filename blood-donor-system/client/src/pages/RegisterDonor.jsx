...
function RegisterDonor() {
  ...
  const validateForm = () => {
    ...
    // Simple phone number validation: allows +, spaces, dashes, parentheses and digits
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        // HARDCODED UNTIL BROWSER GEOLOCATION IS ADDED
      ...
      setStatus({ type: 'success', message: 'Successfully registered! Taking you to your dashboard...' });
      setFormData({ name: '', email: '', password: '', age: '', bloodGroup: '', phone: '', lastDonationDate: '', available: true });
      ...
      <div className="bg-white/90 backdrop-blur-2xl p-8 sm:p-12 rounded-[2.5rem] shadow-[0_20px_60px_rgba(0,_0,_0,_0.05)] border border-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="text-center mb-10">
            <h2 className="text-4xl sm:text-5xl font-black text-gray-900 mb-4 tracking-tight">Become a Hero</h2>
            <p className="text-gray-500 font-medium text-lg">Join the registry and give the gift of life to someone in need.</p>
          </div>
