  ...
  return (
    <div className="max-w-7xl mx-auto py-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-10">
        ...
        {/* Donor Card */}
        <div className="bg-white/75 backdrop-blur-[12px] border border-white/60 rounded-[3rem] shadow-[0_20px_40px_-15px_rgba(220,38,38,0.15)] p-10 transform transition-all duration-700 hover:-translate-y-3 hover:shadow-[0_40px_80px_-15px_rgba(220,38,38,0.2)] flex flex-col items-center text-center group cursor-pointer">
        ...
        {/* Request Card */}
        <div className="bg-white/75 backdrop-blur-[12px] border border-white/60 rounded-[3rem] shadow-[0_20px_40px_-15px_rgba(220,38,38,0.15)] p-10 transform transition-all duration-700 hover:-translate-y-3 hover:shadow-[0_40px_80px_-15px_rgba(30,41,59,0.15)] flex flex-col items-center text-center group cursor-pointer">
